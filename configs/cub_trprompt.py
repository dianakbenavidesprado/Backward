...
def get_args_parser(subparsers):
    ...
    subparsers.add_argument('--epochs', default=1, type=int) #DBP changed default to 1
    ...
    subparsers.add_argument('--n_centroids', default=5, type=int) #DBP changed number of centroids to 5
